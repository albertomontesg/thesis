...
The fail of the feedback architecture may be due to instabilities caused by training with the ground truth instances from the previous output\cite{}. % ALBERTO: Bibliography?
