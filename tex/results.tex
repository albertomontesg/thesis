...
Test & 0.5874 & 0.7554 \\
\hline\hline
Baseline~\cite{caba2015activitynet} & 0.422 & - \\
...
\end{tabular}
\end{center}
\caption{Results of the UPC team at the ActivityNet Challenge 2016 for the classification task. The third-party results are all referred to the test subset.}
...
%On the other hand, the performance at this application, computing the regions after the post-processing, where the activity probabilitu used only as a region proposal is plot on Figure~\ref{fig:recall_vs_iou} where the Recall is plot against the IoU threshold.
...
Challenge Winer & 0.42478 \\
Mean Performance from Challenge Participants & 0.2994 \\
\hline
\end{tabular}
\end{center}
\caption{Results of the UPC team at the ActivityNet Challenge 2016 for the detection task. The third-party results are all referred to the test subset.}
